            ...
            <div class="modal-content">
                <form action="#" @submit.prevent="updatePassword()">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary rounded-0" :disabled="$store.state.isLoading">Update</button>
                    </div>
                </form>
            </div>
        </div>
...
export default {
    ...
    methods: {
        async updateUserProfile() {
            ...
            try {
                const result = await axios.put(`/api/admin/profile/${this.user.id}`, this.user)
                console.log(result)
        ...
        async changePassword() {
            ...
            try {
                const result = await axios.put(`/api/admin/password/${this.user.id}`, {
